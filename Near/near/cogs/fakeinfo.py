...
class FakeInformation(commands.Cog):
    ...
    async def fake(self, ctx, *, fake_mode="help"):
        ...
        if fake_mode == "high":
            try:
                ...
                emf.set_author(name=get_embeds.Common.AUTHOR_NAME, icon_url=get_embeds.Common.AUTHOR_URL)
            ...
            try:
                ...
                emf2.set_author(name=get_embeds.Common.AUTHOR_NAME, icon_url=get_embeds.Common.AUTHOR_URL)
    ...
    async def bottoken(self, ctx):
        ...
        try:
            ...
            embed=discord.Embed(title="Discord Bot Token Generator", description="`{r['token']}`", color=get_embeds.FakeEmbeds.COLOR)
            embed.set_author(name=get_embeds.Common.AUTHOR_NAME, icon_url=get_embeds.Common.AUTHOR_URL)
