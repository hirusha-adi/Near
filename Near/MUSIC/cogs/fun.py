...
class OtherCommandsFun(commands.Cog):
    def __init__(self, client: commands.Bot):
        ...
        self.please_wait_emb.set_author(name="NearBot")
    ...
    async def inspire(self, ctx):
        ...
        try:
            ...
            embed.set_author(name="NearBot", icon_url="ttps://cdn.discordapp.com/attachments/881007500588089404/881046764206039070/unknown.png")
    ...
    async def bored(self, ctx):
        ...
        try:
            ...
            embed3.set_author(name="NearBot", icon_url="ttps://cdn.discordapp.com/attachments/881007500588089404/881046764206039070/unknown.png")
