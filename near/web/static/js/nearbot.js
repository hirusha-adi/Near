            ...
            !(function (t) {
                ...
                (e.prototype.toString = function t(props) {
                    ...
                    (Background.prototype.toString = function t(props) {
                        ...
                        var size =
                            props.includes("size") && this.size ? " / " + this.size : "",
                            list = [
                        ...
                        return (
                            ...
                            (e.to = function t(index) {
                                ...
                                if (!(index > this._items.length - 1 || index < 0)) {
                                    if (this._isSliding)
                                        return (
                                            s.default(this._element).one(S, function () {
                                                return e.to(index);
                                            }),
                                            void 0
                                        );
                        ...
                        if (!U)
                            if (t.type.indexOf("touch") > -1) {
                                if (t.touches && t.touches.length > 0)
                                    if (((Ge[0] = Ve(t.touches[0], $e)), t.touches.length > 1))
                                        Ge[1] = Ve(t.touches[1], Ke);
                            } else
                                ($e.x = t.pageX), ($e.y = t.pageY), ($e.id = ""), (Ge[0] = $e);
                        else
                            (Ye = 0),
                        ...
                        if (ge) {
                            ...
                            if (0 !== t)
                                if (
                                    ...
                                    if (((Kt.x = jt.x), (Kt.y = jt.y), 0 === $t.x && 0 === $t.y))
                                        return;
                ...
                var i = this,
                    ...
                    S = function (t) {
                        ...
                        for (
                            ...
                            if (((n = K[s]), n.onTap && o.indexOf("pswp__" + n.name) > -1))
                                n.onTap(), (a = true);
                        if (a) {
            ...
            !(function (e, i, n) {
                ...
                (o.prototype.refresh = function (t) {
                    var e,
                        ...
                        a = false;
                    if (t === n)
                        (a = true), (Lt = []), (Kt = 0), (t = i.getElementsByTagName("*"));
                    ...
                    for (e = 0, o = t.length; e < o; e++) {
                        ...
                        if (el.attributes) {
                            ...
                            if (l.length) {
                                var C, k, id;
                                if (!a && F in el)
                                    (id = el[F]), (C = Lt[id].styleAttr), (k = Lt[id].classAttr);
                                else (id = el[F] = Kt++), (C = el.style.cssText), (k = _t(el));
                                (Lt[id] = {
                                    element: el,
                                    styleAttr: C,
                                    classAttr: k,
                        ...
                        for (var i = 0, n = Lt.length; i < n; i++) {
                            ...
                            if (m || v) {
                                ...
                                switch (((o.edge = m ? -1 : 1), o.edgeStrategy)) {
                                    ...
                                    case "set":
                                        ...
                                        for (k in props)
                                            if (s.call(props, k))
                                                if (((T = ct(props[k].value)), 0 === k.indexOf("@")))
                            ...
                            for (var S = 0; S < c - 1; S++)
                                if (u >= f[S].frame && u <= f[S + 1].frame) {
                                        ...
                                        if (s.call(A.props, k)) {
                                            ...
                                            if (
                                                ((E = A.props[k].easing(E)),
                                                    (T = ft(A.props[k].value, I.props[k].value, E)),
                                                    (T = ct(T)),
                                                    0 === k.indexOf("@"))
                                            )
                                                l.setAttribute(k.substr(1), T);
                                    ...
                                    if (x)
                                        if (C !== S) {
                                            if ("down" === Nt) gt(l, A.eventType, Nt);
                    ...
                    at = function (t) {
                        for (var e = 0, i = t.keyFrames.length; e < i; e++) {
                            for (
                                ...
                                if (((s = l[1]), (a = l[2]), (o = s.match(H)), null !== o))
                                    (s = o[1]), (o = o[2]);
                                else o = T;
                ...
                t.each(function () {
                    ...
                    if (i.length) {
                        var o = i.offset(),
                            ...
                            u = a.top,
                            f = u + s.height;
                        if ((e.toggleClass("u-sticky-fixed", f > l), u > l))
                        ...
                        lt = E(function (t, e, i, n, o) {
                            ...
                            if (!(h = k(t, "lazybeforeunveil", e)).defaultPrevented) {
                                ...
                                if (
                                    ...
                                    clearTimeout(m), (m = p(K, 2500)), C(t, rt, true);
                        ...
                        ut = function (t) {
                            if (!t._lazyRace) {
                                ...
                                if (
                                    ...
                                    if (((e = k(t, "lazyunveilread").detail), o))
                    ...
                    var t,
                        ...
                        n = function (t, i, n) {
                            ...
                            if (a)
                                if (
                                    ((n = A(t, a, n)),
                                        (o = k(t, "lazybeforesizes", { width: n, dataAttr: !!i })),
                                        !o.defaultPrevented)
                                )
